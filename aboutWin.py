...
"image: url(:/logo/github.png);")
    ...
    def retranslateUi(self, aboutWin):
        ...
        self.label_4.setText(_translate("aboutWin", "测试版 Version1.2.0"))
        ...
        self.label_7.setText(_translate("aboutWin", "<html><head/><body><p>作者：帆登</p></body></html>"))
        self.label_8.setText(_translate("aboutWin", "<html><head/><body><p>官网：<a href=\"https://blog.simgor.cn\"><span style=\" text-decoration: underline; color:#55aaff;\">https://wordcard.eace.top</span></a></p></body></html>"))
        self.label_9.setText(_translate("aboutWin", "<html><head/><body><p>Copyright © 2020-2023 Simgor001。保留所有权利。</p></body></html>"))
